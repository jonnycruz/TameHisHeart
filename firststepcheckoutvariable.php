...
<div id="wrapper">
        ...
        <form action="checkoutvariable-step2.php" method="get" enctype="multipart/form-data" class="form-horizontal">
...
<h3 style="margin:0px 0px 0px 0px; text-align:center;">Tame His Heart Secure Order Form</h3>
           <div style="max-width:820px; width:auto; margin: 0 auto;"> 
...
<table border="0">
      ...
      <tr>
        <td valign="top" align="right"></td>
        <td><p style="max-width:500px; width:auto; margin: 3 auto; float:left;"><span style="font-weight:bold;">Total Value: </span><br/>
          </p></td>
        <td>Valued at $294.00</td>
      <tr>
        <td colspan="3"><hr style="height:1px;border:none;color:#CCC;background-color:#333;" /></td>
      </tr>
      <tr>
        <td valign="top" align="right"></td>
        <td><p style="max-width:500px; width:auto; margin: 3 auto; float:left;"><span style="color:#C00; font-weight:bold;">Your Price Today</span><br/>
          </p></td>
        <td><span style="color:#C00; font-weight:bold;">$0.00</span></td>
      <tr>
        <td colspan="3"><hr style="height:1px;border:none;color:#CCC;background-color:#333; margin-bottom: 3px;" /></td>
      </tr>
    </table>
            </div>
        <div class="col-md-3 hidden-this" style="margin-left:50px;">
 <img src="_img/money_back_guarantee.png" style="max-width:180px; width:100%;" />
    <p style="max-width:180px; width:100%; font-size:12px; margin-top:3px;"> Remember 100% Guaranteed. <span style="color:#C00; font-weight:bold;">You will NOT be charged</span>, and can try the popular Tame His Heart program, absolutely FREE for 7 Days.<br />
    </p>
...
<div style="min-width:300px; max-width:800px; margin: 0 auto;">
  <div class="small payment-one clearfix" style="text-align: center;">
    ...
    <div class="methods clearfix" style="max-width:800px; width:auto; margin: 0 auto;">
      <div class="radio col-sm-2">
        <label>
          ...
          <img src="_img/visa.png" class="img-responsive" alt="" style="max-height:50px;"> </label>
      </div>
      <div class="radio col-sm-2" style="margin-top: 10px;">
        <label>
          <input name="type" type="radio" value="">
          <img src="_img/amex.png" class="img-responsive" alt="" style="max-height:50px;"> </label>
      </div>
      <div class="radio col-sm-2" style="margin-top: 10px;">
        <label>
          <input name="type" type="radio" value="">
          <img src="_img/mastercard.png" class="img-responsive" alt="" style="max-height:50px;"> </label>
      </div>
      <div class="radio col-sm-2" style="margin-top: 10px;">
        <label>
          <input name="type" type="radio" value="">
          <img src="_img/discover.png" class="img-responsive" alt="" style="max-height:50px;"> </label>
      </div>
    </div>
    <h4>Which country are you from?</h4>
    <select name="country" class="form-control" rows="4" style="max-width:250px; width:100%; margin: 0 auto;">
    ...
    <input type="text" class="form-control" rows="4" style="max-width:250px; width:100%; margin: 0 auto;"  name="email" id="email" placeholder="Email" />
    <div>
    ...
    <textarea class="form-control" rows="4" style=" min-width:220px; max-width:400px; margin: 0 auto;">
