...
<body><?php include_once("_includes/gacheckoutcontrol.php") ?><script src='https://www1.moon-ray.com/v2.4/analytics/tracking.js' type="text/javascript"></script>
<script type="text/javascript">
_mri = "12106_3_2";
mrtracking();
</script>
...
<div id="wrapper">
  ...
  <div class="container video clearfix" > 
    <form action="checkoutcontrol-step2.php" method="get" enctype="multipart/form-data">
  <img src="/_img/bar.png" class="img-responsive" alt="Checkout Now" style="margin:0px 0px 0px 0px 0px; display: block; margin-left: auto; margin-right: auto; width:60%" />
    ...
    <div  class="row col-md-12" style="max-width:800px; margin: 0 auto;">
      <hr style="height:3px;border:none;color:#333;background-color:#333;" />
      <ul style="max-width:800px; width:auto; margin: 0 auto;">
        <li style="font-size:18px"> Tame His Heart and Turn Him ON Downloadable eBook - $29.97 after FREE 7 Day Trial </li>
        <br />
        <li style="font-size:18px">Discussions With OneTaste's Dating Experts ($19.97 per month after FREE 30 day trial)</li>
        <br />
        <li style="font-size:18px">Bonus Intreview With Dating and Relationship Experts - Yours To Keep - FREE</li>
      </ul>
      <hr style="height:3px;border:none;color:#333;background-color:#333;" />
    </div>
    <div class="small payment-one clearfix" style="text-align: center;">
      ...
      <select name="country" class="input-sm">
