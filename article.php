<?php
    ...
    header('Location: /paywall.html?article=articleo');
...
<?=View::load('_frame-start', array('title' => 'Two Reasons Why Hell Run From Intimacy'))?>
		...
		<div class="container video clearfix">
			<div class="article-header col-md-12">
				<div class="pull-left avatar">
					<img src="/_img/nicole.png" alt="" />
				</div>
				<h2 class="head_black">Two Reasons Why He'll Run From Intimacy<sub>by Nicole Daedone</sub></h2>
			</div>
			<div class="col-md-8">
				
				<div class="article">
					<p class="excerpt"><img class="img-responsive" src="http://onetaste.us/wp-content/uploads/2013/05/turnedonwomen.jpg" alt="" /><em style="margin-bottom:28px">If you've ever tried convincing a man you're a great match or attempted to buy his love with gifts, you know it never works in the long run.</em> Learn how to avoid doing what makes him run and what you need to be doing instead to get him to really feel a connection.</p>
					...
					<ol>
						<li>
							Why Your Insecurity Will Kill Your Relationship
							<div style="font-weight:normal">
								...
								<p>He’s confused. He may say in the moment that he cares about her (he won’t say he loves her). He may even seem to give into what she wants. Yet, mostly he’s just trying to push her tears back and stop the emotional outpouring. Later after he’s left he’ll push away even further. The relationship is over.</p>
							</div>
						</li>
						<li>
							Why Coming On “Too Strong, Too Soon” Pushes Him Away
							<div style="font-weight:normal">
								<p>The biggest mistake you can make in a relationship with a man is feeling insecure. Insecurity creates a negative feedback loop that will destroy your relationship.</p>
								<p>Chances are that deep down you already know what I’m about to tell you here… 
The simple fact is that if a man isn’t into you all your attempts at showing him love will come off as try-hard and creepy. Even though you may have good intentions, these loving gestures will push him further away. </p>
					...
					<h4>He’ll Love You if You Love You </h4>
					...
					<p>In my Relationships By Design eBook, I dive into how you can achieve an inner confidence, positive attitude and project emotional stability that sparks intense attraction in a man. </p>
					<p>Imagine what it would feel like to have him interested in the parts of your life that have meaning to you. On page X of my book, I’ll show you the exact actions and words that generate an intense connection between you and your man. He won’t just want you. He’ll need you.</p>

					<p>Go here now for more details, <a href="/index-b.php">Tame His Heart and Turn Him On</a> free for seven days and you’ll find out how to build a deeper connection with a man than you’ve ever experienced.</p>
				</div>
