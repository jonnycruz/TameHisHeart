<?php 
	...
	$ga_skucode = "OT-Dating";
	$ga_product = "1. Discussions with Dating Experts";
	$ga_category = "none";
	$ga_unit_price = "19.97";
	$ga_quantity = "1";
    ...
    case "storename":
	 ...
	 case "skucode":
        ...
        break;
	 case "product":
        return 'Discussions with Dating Experts';
        break;
	 case "category":
        return 'none';
        break;
...
<head>
	...
	<title>Thank You For Purchasing: Interviews With Our Dating Experts</title>
			...
			<div class="col-md-12">
			  ...
			  <h3>Your Order Has Been Approved</h3>
				<div class="article small clearfix">
					<p>Congratulations for taking an amazing step towards improving your dating and relationship skills. I hope you'll remember this day as the first day you started to change your love life for the better.</p>
                    
<p>Below I've listed your order details and your access pages. Click
  on the link below to start listening to Discussions with OneTaste's Dating Experts instantly and start having the
...
advice.</p>
          <p>Sincerely,<br/>
          Joanna Van Vleck</p>
          <p class="indent">Initial Charge: $0.00 (via Credit Card)</p>
         <p class="indent"><img src="/_img/thhcds.png" height="150" /></p>
         <p class="indent">1. Discussions with OneTaste's Dating Experts ($19.97 per month after FREE 30 day trial)</p>
          <p class="indent">
            <a href="/download-interviews.php">
              Access: Discussions with OneTaste's Dating Experts Now</a>
          </p>
          <p class="indent">Your download link will be valid for 60 days from
today.</p>
          <hr/>
          <h4>This is How You Access Your "<span class="indent">Discussions with OneTaste's Dating Experts</span>"
Purchase</h4>
...
link:</p>
          ...
          <p>In your inbox you’ll receive an email order receipt that contains your unique URL. You may want to "copy-and-paste" the information in your email into a document on your computer for safekeeping.  
		  </p></div>
			</div>
