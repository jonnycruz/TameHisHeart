...
<div id="combo">
	...
	(function($){
    $(document).bind('ready.moonray_order_form_jb_617',function(){
        $("div.jb_617 form").moonrayOrderForm({
            timeZoneOffset:8,
            products:{"7":{"chargedToday":0,"chargedLater":[{"amount":0,"count":"1","unit":"month","type":"delay_price"},{"amount":"0","count":"1","unit":"month","type":"trial"}],"delayDate":false,"taxable":false,"shippable":false,"hasPaymentPlans":true}}
        }); 
    });
})(jQuery);
