...
<head>
	...
	<title>Thank You For Purchasing: Tame His Heart and Turn Him ON eBook | The Keys to a Lasting Intimate Connection</title>
...
<body><?php include_once("_includes/gathankyouthhsaleic.php") ?>
		...
		<div class="container video clearfix">
			...
			<div class="col-md-12">
			  ...
			  <div class="article small clearfix">
					...
					<p>Below are your order details and your access page. Click on the link below to start watching your videos and reading your eBook instantly</p>
...
today</p>
          <hr/>
          <h4>This is How You Access Your Keys to an Intimate Connection Video Series and your eBook Tame His Heart and Turn Him ON Purchases</h4>
