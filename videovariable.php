...
<head>
	...
	<link type="text/css" media="screen" rel="stylesheet" href="_css/responsive.css" />
...
<script type="text/javascript">
	...
	$(function() { // Shorthand for $(document).ready(function() {
      $('.fader').hide().delay(700000).fadeIn(2200);
	  $('.btn').hide().delay(700000).fadeIn(2200);
	    $("#whitespace").fadeIn(2).delay(700000).fadeOut(2200);
...
<body>
	...
	<div id="wrapper">
		...
		<div class="container video clearfix" style="margin-top:0px; text-align:center;">
		  ...
		  <div id="header" style="margin: 0 auto; max-width:700px;">
			<h2 align="center" style="margin-top:2px; margin-bottom:2px;"><span style="font-size:30px; color:#CE0C0C;">7 Ugly Mistakes Women Make That Force Him To Pull Away</span></h2>
		  </div>
...
<iframe src="//fast.wistia.net/embed/iframe/r8wgow24tr?videoFoam=true" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_embed" name="wistia_embed" allowfullscreen mozallowfullscreen webkitallowfullscreen oallowfullscreen msallowfullscreen width="640" height="360"></iframe><script src="//fast.wistia.net/assets/external/iframe-api-v1.js"></script>
       ...
       <div align="center">     <a href="/firststepcheckoutvariable.php" class=" btn btn-success">
  ...
  <?=View::load('testimonials-widget')?>
				  	...
				  	<div class="col-md-7 sidebar" style="padding-top:26px">

                 <div class="widget clearfix">
	<div class="special">
		<h2>Letter From Joanna</h2>
	</div>
	<div class="letter" style="padding-left:5px; padding-right:5px;">
...
Joanna Van Vleck</p>
	...
	<div class="special clearfix">
		<div class="discount-header">
		  <h2 style="margin:0" align="center">Try My e-Book Risk Free</h2>
	...
	<div class="book clearfix">
		...
		<div class="col-sm-8">
          ...
          <a href="/firststepcheckoutvariable.php" class="btn btn-success">
					<i class="fa fa-download fa-lg"></i> READ IT FREE!</a>
