...
<div style="float: left; margin-left:25px; margin-top:60px; margin-bottom:20px; border: 5px solid grey;"><script type="text/javascript" src="http://content.jwplatform.com/players/V12JNUz3-abT4xa2u.js"></script></div>
				<div class="col-md-5 sidebar"><br /><br />
    ...
    ><img src="/_img/thhbookcd.png" style="float:left; padding-right:20px;" height="100" />
	<!--<h4>You get:</h4>-->
...
OFF</span>
        ...
        <a href="/checkout.php" class="download btn btn-primary">
				...
				<ul class="links list-inline">
					<li><a href="#" onclick="window.open('purchase-policies.html', 'purchasepolicies', 'width=500, height=800, resizable=0')">Purchase Policy</a></li>
