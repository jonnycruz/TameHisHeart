...
<body><?php include_once("_includes/gacontroloptin.php") ?>
	...
	<div id="wrapper">
		...
		<div class="container video clearfix" style="margin-top:0px; text-align:center;">
		  ...
		  <div id="header" style="margin: 0 auto; max-width:800px; width:100%;">
			<h2 align="center" style="margin-top:2px; margin-bottom:2px;"><span style="font-size:30px; color:#CE0C0C;">You Did It!<br>
Now Watch This  VIDEO, For The Exact Words to Make a Man Fall Deeply In LOVE</span></h2>
		  </div>
