...
<body><?php include_once("_includes/gathankyousaleall.php") ?>
...
mrtracking();
	...
	<div id="wrapper">
		...
		<div class="container video clearfix">
         ...
         <p class="indent">3. Discussions with OneTaste's Dating Experts ($19.97 per month after FREE 30 day trial)</p>
          <p class="indent">
            <a href="/download-all.php">
