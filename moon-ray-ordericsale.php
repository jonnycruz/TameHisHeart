...
<div id="combo" style="padding:0px 0px 0px 150px;">
	<script type="text/javascript">
	(function($){
    $(document).bind('ready.moonray_order_form_jb_772',function(){
        $("div.jb_772 form").moonrayOrderForm({
            timeZoneOffset:8,
            products:{"16":{"chargedToday":0,"chargedLater":[{"amount":0,"count":"1","unit":"month","type":"delay_price"},{"amount":"0","count":"1","unit":"month","type":"trial"}],"delayDate":false,"taxable":false,"shippable":false,"hasPaymentPlans":true}}
        }); 
    });
})(jQuery);
	</script>    <script type="text/javascript" src="https://www1.moon-ray.com/v2.4/analytics/genf.php?f=p2c12106f37"></script>
<!-- End Combo Form -->
</div>

<div id="solo" style="display: none; padding:0px 0px 0px 150px;">
<!-- Start Solo Form -->
	<script type="text/javascript">
	(function($){
    $(document).bind('ready.moonray_order_form_jb_772',function(){
