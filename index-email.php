...
<head>
	...
	<title>Joanna Van Vleck's Tame His Heart and Turn Him ON</title>
...
<div style="width:50%; height:50%; float: left; margin-left:25px; margin-top:60px; margin-bottom:20px; border: 5px solid grey; min-width:300px;"><script type="text/javascript" src="http://content.jwplatform.com/players/V12JNUz3-abT4xa2u.js"></script></div>
    ...
    ><img src="/_img/thhbookcd.png" style="float:left; padding-right:20px;" width="100" />
	<!--<h4>You get:</h4>-->
