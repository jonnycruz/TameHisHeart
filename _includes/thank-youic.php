<?php
 ...
 cookievalues($input);  
  ...
  $trans_id = cookievalues("transaction_id"); 
...
<body><?php include_once("_includes/gathankyouic.php") ?><script src='http://www1.moon-ray.com/v2.4/analytics/tracking.js' type='text/javascript'></script>
<script>
_mri = "12106_3_2";
mrtracking();
</script>
