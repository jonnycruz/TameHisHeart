...
<body><?php include_once("_includes/gacheckoutcontrol-step2.php") ?><script src='https://www1.moon-ray.com/v2.4/analytics/tracking.js' type="text/javascript"></script>
<script type="text/javascript">
_mri = "12106_3_2";
mrtracking();
</script>
...
$(function() { // Shorthand for $(document).ready(function() {	
 $("#soloform").hide();
 $("#billing_country").val('<?=$_POST['country']?>');
...
<div id="wrapper">
  ...
  <div class="container video clearfix" > <img src="/_img/bar.png" class="img-responsive" alt="Checkout Now" style="margin:0px 0px 0px 0px 0px; display: block; margin-left: auto; margin-right: auto; width:100%; max-width:850px;" />
    ...
    <div style="max-width:800px; width:auto; margin: 0 auto;">
      <hr style="height:3px;border:none;color:##999;;background-color:#333;" />
      <ul style="max-width:800px; width:auto; margin: 0 auto;">
        <li style="font-size:18px"> Tame His Heart and Turn Him ON Downloadable eBook - $29.97 after<span style="color:#C00; font-weight:bold;"> FREE 7 Day Trial</span> </li>
        <br />
        <div id="subscription">
          <li id="subscription" style="font-size:18px">Discussions With OneTaste's Dating Experts ($19.97 per month after <span style="color:#C00; font-weight:bold;">FREE 30 day trial</span>)</li>
          <br />
          <li id="subscription" style="font-size:18px">Bonus Intreview With Dating and Relationship Experts - Yours To Keep -<span style="color:#C00; font-weight:bold;"> FREE</span></li>
        </div>
      </ul>
      <hr style="height:3px;border:none;color:#999; background-color:#333;" />
      <div class="article small" style="text-align:center; margin-top:1px;">
        <div class="widget-basic col-md-12" style="width:100%; padding: 1px 3px 1px 3px;">
          <div class="checkbox">
            <label>
  ...
  .row {
    ...
    $(document).bind('ready.moonray_order_form_jb_679',function(){
        ...
        <![endif]-->
        <div id="comboform" class="row col-md-12" style="max-width:630px;margin:0 auto;">
          <div class="col-md-7">
            <div class="moonray_forms moonray_order_form jb_679 moon-ray-hide-quick-cost">
              <form action="https://forms.moon-ray.com/v2.4/form_processor.php?" method="post">
                ...
                <fieldset class="contactInfo moonray_form_format_labels_on_top">
                  <div class="row">
                    <div class="cell firstname">
                      <label class="moonray_fieldname mr_firstname" for="firstname">First Name<span class="moonray_required">*</span></label>
                      <input type="text" name="firstname" value="" class="moonray_input required text" size="30"/>
                    </div>
                    <div class="cell lastname">
                      <label class="moonray_fieldname mr_lastname" for="lastname">Last Name<span class="moonray_required">*</span></label>
                      <input type="text" name="lastname" value="" class="moonray_input required text" size="30"/>
                    </div>
                    <br>
                  </div>
                  <div class="row email">
                    <label class="moonray_fieldname mr_email" for="email">Email<span class="moonray_required">*</span></label>
                    <input type="text" name="email" id="email" value="" class="moonray_input required text" size="30"/>
                  </div>
                  <br />
                  <label class="moonray_fieldname mr_cell_phone" for="cell_phone">Phone Number</label>
                  <br>
                  <input type="text" name="cell_phone" value="" class="moonray_input  phone" size="30"/>
                  <br>
                </fieldset>
                <fieldset class="billingAddress moonray_form_format_labels_on_top">
                  <div class="row double">
                    <label class="moonray_fieldname mr_billing_address1" for="billing_address1">Billing Address<span class="moonray_required">*</span></label>
                    <input type="text" name="billing_address1" value="" class="moonray_input required text" size="30"/>
                    <br>
                  </div>
                  <div class="row double">
                    <label class="moonray_fieldname mr_billing_address2" for="billing_address2">Address 2</label>
                    <input type="text" name="billing_address2" value="" class="moonray_input  text" size="30"/>
                    <br>
                  </div>
                  <div class="row">
                    <div class="cell country">
                      <label class="moonray_fieldname mr_billing_country" for="billing_country">Country<span class="moonray_required">*</span></label>
                      <select name="billing_country" id="billing_country" class="moonray_input required">
                        <option value=''></option>
                    ...
                    <div class="cell zip">
                      <label class="moonray_fieldname mr_billing_zip" for="billing_zip">Postal Code<span class="moonray_required">*</span></label>
                      <input type="text" name="billing_zip" value="" class="moonray_input required text" size="30"/>
                    </div>
                    <br>
                  </div>
                  <div class="row">
                    <div class="cell city">
                      <label class="moonray_fieldname mr_billing_city" for="billing_city">City<span class="moonray_required">*</span></label>
                      <input type="text" name="billing_city" value="" class="moonray_input required text" size="30"/>
                    </div>
                    <div class="cell state">
                      <label class="moonray_fieldname mr_billing_state" for="billing_state">State<span class="moonray_required">*</span></label>
                      <select name="billing_state" class="moonray_input required">
                        <option value=''></option>
                  ...
                  <div class="row">
                    <input type="checkbox" class="checkbox differentShippingAddress" name="differentShippingAddress" id="differentShippingAddress" value="yes">
                    <label for="differentShippingAddress" class="checkbox">My shipping address is different</label>
                    <br />
                  </div>
                </fieldset>
                <fieldset class="ui-helper-hidden shippingAddress moonray_form_format_labels_on_top">
                  <div class="row double">
                    <label class="moonray_fieldname mr_shipping_address1" for="shipping_address1">Shipping Address</label>
                    <input type="text" name="shipping_address1" value="" class="moonray_input  text" size="30"/>
                    <br>
                  </div>
                  <div class="row double">
                    <label class="moonray_fieldname mr_shipping_address2" for="shipping_address2">Address 2</label>
                    <input type="text" name="shipping_address2" value="" class="moonray_input  text" size="30"/>
                    <br>
                  </div>
                  <div class="row">
                    <div class="cell country">
                      <label class="moonray_fieldname mr_shipping_country" for="shipping_country">Country</label>
                      <select name="shipping_country" class="moonray_input ">
                        <option value=''></option>
                        <option value='US'>United States</option>
                        <option value='CA'>Canada</option>
                        <option value='GB'>United Kingdom</option>
                    ...
                    <div class="cell zip">
                      <label class="moonray_fieldname mr_shipping_zip" for="shipping_zip">Postal Code</label>
                      <input type="text" name="shipping_zip" value="" class="moonray_input  text" size="30"/>
                    </div>
                    <br>
                  </div>
                  <br />
                  <div class="row">
                    <div class="cell city">
                      <label class="moonray_fieldname mr_shipping_city" for="shipping_city">City</label>
                      <input type="text" name="shipping_city" value="" class="moonray_input  text" size="30"/>
                    </div>
                    <div class="cell state">
                      <label class="moonray_fieldname mr_shipping_state" for="shipping_state">State</label>
                      <select name="shipping_state" class="moonray_input ">
                        <option value=''></option>
                        <option value='AL'>Alabama</option>
                        <option value='AK'>Alaska</option>
                        <option value='AZ'>Arizona</option>
                ...
                <fieldset class="paymentInfo moonray_form_format_labels_on_top">
                  <div class="credit_cards moonray-form-cc-logo-new-markup"></div>
                  <br>
                  <div class="mr_cc">
                    <div class="row">
                      <div class="cell ccNum">
                        <label class="moonray_fieldname mr_payment_number" for="payment_number">Card Number<span class="moonray_required">*</span></label>
                        <br>
                        <input type="text" name="payment_number" value="" class="moonray_input required text" size="30"/>
                      </div>
                      <div class="cell ccCVC">
                        <label class="moonray_fieldname mr_payment_code" for="payment_code">CVC<span class="moonray_required">*</span></label>
                        <br>
                        <input type="text" name="payment_code" value="" class="moonray_input required text" size="30"/>
                        <a href="" class="ui-state-default ui-corner-all cvchelp"><span class="ui-icon ui-icon-help"></span></a></div>
                      <br>
                    </div>
                    <div class="row expire">
                      <label class="moonray_fieldname mr_payment_expire" for="payment_expire">Expiration Date<span class="moonray_required">*</span></label>
                      <br>
                      <select name="payment_expire_month" class="moonray_cc_expire_month required">
                      ...
                      <select name="payment_expire_year" class="moonray_number moonray_cc_expire_yearrequired">
                ...
                <input type="submit" value="Finish Order" class="mr-submit" style="float:right; color:#FFF; font-weight:bold; background-color:#C00 !important; font-size:20px; height:50px; width:150px">
              </form>
            </div>
          </div>
          <div class="col-md-5 text-center  hidden-xs" style="max-width:180px;"> 
          <img src="_img/money_back_guarantee.png" style="max-width:180px; width:100%;" />
            <p style="max-width:180px; width:100%; font-size:12px;">Remember 100% Guaranteed. <span style="color:#C00; font-weight:bold;">You will NOT be charged</span>, and can try the popular Tame His Heart program, absolutely FREE for 7 Days.</p>
        ...
        <div id="soloform" class="row col-md-12" style="max-width:630px;margin:0 auto;">
          <link type="text/css" rel="stylesheet" href="https://forms.moon-ray.com/v2.4/include/minify/?g=moonrayCSS" />
          <link type="text/css" rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/smoothness/jquery-ui.css" />
          <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script> 
          <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.2/jquery-ui.min.js"></script> 
          ...
          <script type="text/javascript">
	(function($){
    $(document).bind('ready.moonray_order_form_jb_564',function(){
        $("div.jb_564 form").moonrayOrderForm({
            timeZoneOffset:8,
        ...
        <![endif]-->
          <div class="col-md-7">
            <div class="moonray_forms moonray_order_form jb_564 moon-ray-hide-quick-cost">
              <form action="https://forms.moon-ray.com/v2.4/form_processor.php?" method="post">
                <input type="hidden" name="hash" value="a87ff679a2f3e71d9181a67b7542122c">
                <input type="hidden" name="uid" value="p2c12106f4">
                <input type="hidden" name="tags" value="">
                <input type="hidden" name="sequence" value="">
                <input type="hidden" name="contact_id" id="contact_id_jb_564" value="" />
                <input type="hidden" id="afft_jb_564" name="afft_" value="" />
                <input type="hidden" id="aff_jb_564" name="aff_" value="" />
                <input type="hidden" id="sess_jb_564" name="sess_" value="" />
                <input type="hidden" id="ref_jb_564" name="ref_" value="" />
                <input type="hidden" id="own_jb_564" name="own_" value="" />
                <input type="hidden" id="oprid_jb_564" name="oprid" value="" />
                <fieldset class="contactInfo moonray_form_format_labels_on_top">
                  <div class="row">
                    <div class="cell firstname">
                      <label class="moonray_fieldname mr_firstname" for="firstname">First Name<span class="moonray_required">*</span></label>
                  ...
                  <div class="row email">
                    <label class="moonray_fieldname mr_email" for="email">Email<span class="moonray_required">*</span></label>
                    <input type="text" name="email" value="" class="moonray_input required text" size="30"/>
                  </div>
                  <br />
                  <label class="moonray_fieldname mr_cell_phone" for="cell_phone">Phone Number</label>
                  <br>
                ...
                <fieldset class="billingAddress moonray_form_format_labels_on_top">
                  ...
                  <div class="row">
                    <div class="cell country">
                      <label class="moonray_fieldname mr_billing_country" for="billing_country">Country<span class="moonray_required">*</span></label>
                      <select name="billing_country" class="moonray_input required">
                        <option value=''></option>
                        <option value='US'>United States</option>
                        <option value='CA'>Canada</option>
                        <option value='GB'>United Kingdom</option>
