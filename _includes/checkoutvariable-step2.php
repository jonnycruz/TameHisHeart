...
<body><?php include_once("_includes/gacheckoutvariable-step2.php") ?><script src='https://www1.moon-ray.com/v2.4/analytics/tracking.js' type="text/javascript"></script>
<script type="text/javascript">
_mri = "12106_3_2";
mrtracking();
</script>
...
<div id="wrapper">
 ...
 <fieldset class="contactInfo moonray_form_format_labels_on_top">
     <h2 style="font-size:22px; margin:2px 0px 2px 0px;"><u>Enter Your Payment Details</u></h2>
        ...
        <div class="row">
             ...
             <div class="cell firstname">
                <tr> 
                  <td><input type="text" name="firstname" value="" class="moonray_input required text" size="50" placeholder="First Name*" style="max-width:300px; width:100%;"/></td>
              
                </tr></div><div class="cell lastname">
                <tr>
                  <td> <input type="text" name="lastname" value="" class="moonray_input required text" size="50" placeholder="Last Name*" style="max-width:300px; width:100%;"/></td>
                 
                </tr></div> 
                 <div class="row email">
                <tr>
                  <td> 
           <input type="text" name="Email*" value="" class="moonray_input required text" size="50" placeholder="email" style="max-width:300px; width:100%;"/></td>
                ...
                <tr>
                  <td> 
           <input type="text" name="cell_phone" value="" class="moonray_input  phone" size="50" placeholder="Phone Number" style="max-width:300px; width:100%;"/></td>
    ...
    <fieldset class="paymentInfo moonray_form_format_labels_on_top"><div class="credit_cards moonray-form-cc-logo-new-markup"></div>
  
        
        
        
        <div class="mr_cc">
           <h2 style="font-size:22px; margin:0px 0px 2px 0px;"><u>Credit Card Details</u></h2>
            <div class="row">
                <div class="cell ccNum">
                <label class="moonray_fieldname mr_payment_number" for="payment_number"></label><br><input type="text" name="payment_number" value="" class="moonray_input required text" size="30" placeholder="Card Number*"/></div>
                <div class="cell ccCVC"><br><input type="text" name="payment_code" value="" class="moonray_input required text" size="30" placeholder="CVC"/> <a href="" class="ui-state-default ui-corner-all cvchelp"><span class="ui-icon ui-icon-help"></span></a></div>
                <br>
            </div>
    ...
    <!--[if IE]> 
        ...
        <![endif]-->
    <div class="col-md-7">
            <div class="moonray_forms moonray_order_form jb_856 moon-ray-hide-quick-cost">
    <form action="https://forms.moon-ray.com/v2.4/form_processor.php?" method="post">
