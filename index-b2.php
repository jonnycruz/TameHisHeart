...
<head>
	...
	<title>Tame His Heart and Turn Him On eBook| Dating Advice to Keep Your Man Happy</title>
...
<body>
	...
	<div id="picture" class="hidden-xs">
    	<img src="http://onetaste.us/wp-content/uploads/2013/05/turnedonwomen.jpg" />
    </div>
</nav>
<div class="container">
	<div id="header">
		<div class="col-md-2">
			<a href="/"><img src="http://onetaste.us/wp-content/uploads/2013/09/Powered-by-Orgasm-OT.png" /></a>
		</div>
		<div class="title col-md-7">
			<h2>Relationships by Design<sub>"We're here to help you attract your ideal man, tell you his dating thoughts, reveal how to make his love lasting and intense and make him commit when <u>YOU</u> want..."</sub></h2>
		</div>
		...
		<div class="container video clearfix">
			<div class="col-md-12">
				<h2>Charm your perfect partner and make him crave committment...</h2>
			</div>
			<div class="clearfix">
				<div class="col-md-7">
					
					<div style="float:left; overflow:hidden; display:block; width:650px; height:400px; padding:10px 0px 0px 17px; clear:both;">
                   <script type="text/javascript" src="http://content.jwplatform.com/players/V12JNUz3-abT4xa2u.js"></script></div><br /><br /><br />
				
				</div><br /><br /><br />
				<div  style="border: 1px solid grey; float:right; background:#CCCCCC; overflow:hidden; display:inline-block;  width:100; height:600;" >

					<div class="widget hidden-sm hidden-xs clearfix">
	<h2>Try it today with our 7-Day RISK FREE Trial</h2>
	<ul class="feature pull-left" style="margin:10px 0 0">
		<li>The <strong>Relationships by Design</strong> e-Book</li>
...
OFF</span>
	...
	<div class="special clearfix">
		<div class="discount-header">
			...
			<h2 style="margin:0">7-Day Risk Free Trial &amp; Bonus CD</h2>
		</div>
	</div>
	<h4 style="margin-top:0;text-align:center">Try our <strong>Relationship by Design</strong> e-Book and you will learn...</h4>
	<div class="book clearfix">
		...
		<div class="col-sm-8">
			<ul class="feature">
				<li>The keys to attracting <em>any man</em></li>
				<li>5 date-stopper mistakes you may be making with men</li>
				<li>How to tell if he only wants you for sex</li>
				<li>Make HIM ask <em>YOU</em> for a commitment</li>
	...
	<div id="footer">
		<div class="container clearfix">
			<ul class="pull-left">
				<li class="{HOME}"><a href="/">Download Now</a></li>
	    		<li class="{OPTIN}"><a href="/index-b.html">Optin</a></li>
				<li class="{PAYWALL}"><a href="/paywall.html">Paywall</a></li>
        		<li class="{ARTICLE}"><a href="/article.html">Article</a></li>
