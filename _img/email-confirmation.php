...
<div style="padding-left:25px; padding-top:20px;"><script type="text/javascript" src="http://content.bitsontherun.com/players/qr4eSgfF-abT4xa2u.js"></script></div>
    ...
    <div class="details">
      ...
      <p style="font-size: 16px;">
          <ul style="margin-bottom: 0;">
            <li style="padding: 0; font-size: 16px;">Tame His Heart and Turn Him ON eBook</li>
            <li style="padding: 0; font-size: 16px;">Bonus Monthly Discussions with OneTaste's Dating Experts ($20 value)</li>
          </ul>
          <p style="clear: both;"><a href="http://tamehisheart.com/checkout.php?optin=true" class="label label-primary label-md" style="color: white;">Watch It Now</a></p>
    </div>
  </li>
</ul>
