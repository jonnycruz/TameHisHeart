...
<body><?php include_once("_includes/gathankyouthhms.php") ?>
...
mrtracking();
	...
	<div id="wrapper">
		...
		<div class="container video clearfix">
          ...
          <p class="indent"><img src="/_img/thhcds.png" height="150" /></p><p class="indent">2. Discussions with OneTaste's Dating Experts ($19.97 per month after FREE 30 day trial)</p>
          <p class="indent">
            <a href="download-thh-ms.php">
