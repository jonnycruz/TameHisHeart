...
<div class="small payment-one clearfix" style="text-align: center; display:block; margin-left:auto; margin-right:auto; width:80%;">
...
<div class="article small" style="display:none;margin-top:0; padding-top:0px;">
...
<div id="combo">
	...
	(function($){
    $(document).bind('ready.moonray_order_form_jb_258',function(){
        $("div.jb_258 form").moonrayOrderForm({
            timeZoneOffset:8,
            products:{"18":{"chargedToday":0,"chargedLater":[{"amount":0,"count":"1","unit":"month","type":"delay_price"},{"amount":"0","count":"1","unit":"month","type":"trial"}],"delayDate":false,"taxable":false,"shippable":false,"hasPaymentPlans":true}}
        }); 
    });
})(jQuery);
	</script>    <script type="text/javascript" src="https://www1.moon-ray.com/v2.4/analytics/genf.php?f=p2c12106f45"></script>
<!-- End Combo Form -->
</div>
