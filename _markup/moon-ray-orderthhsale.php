...
<div id="combo">
	...
	(function($){
    $(document).bind('ready.moonray_order_form_jb_305',function(){
        $("div.jb_305 form").moonrayOrderForm({
            timeZoneOffset:8,
            products:{"4":{"chargedToday":0,"chargedLater":[{"amount":"19.97","count":"1","unit":"month","type":"sub","date":false},{"amount":"0","count":"1","unit":"month","type":"trial"}],"delayDate":false,"taxable":false,"shippable":false,"hasPaymentPlans":false},"15":{"chargedToday":0,"chargedLater":[{"amount":14.99,"count":"1","unit":"week","type":"delay_price"},{"amount":"0","count":"1","unit":"week","type":"trial"}],"delayDate":false,"taxable":false,"shippable":false,"hasPaymentPlans":false}}
        }); 
    });
})(jQuery);
	</script>    
    ...
    <div class="moonray_forms moonray_order_form jb_305 moon-ray-hide-quick-cost">
    <form action="https://forms.moon-ray.com/v2.4/form_processor.php?" method="post">
    <input type="hidden" name="hash" value="6364d3f0f495b6ab9dcf8d3b5c6e0b01">
    <input type="hidden" name="uid" value="p2c12106f32">
    <input type="hidden" name="tags" value="">
    <input type="hidden" name="sequence" value="">
	
	<input type="hidden" name="contact_id" id="contact_id_jb_305" value="" />
	<input type="hidden" id="afft_jb_305" name="afft_" value="" />
	<input type="hidden" id="aff_jb_305" name="aff_" value="" />
	<input type="hidden" id="sess_jb_305" name="sess_" value="" />
	<input type="hidden" id="ref_jb_305" name="ref_" value="" />
	<input type="hidden" id="own_jb_305" name="own_" value="" />
	<input type="hidden" id="oprid_jb_305" name="oprid" value="" />
...
<!-- Start Solo Form -->
    ...
    <script type="text/javascript" src="https://forms.moon-ray.com/v2.4/include/minify/?g=moonrayJSCart"></script>
    	<script type="text/javascript">
	(function($){
    $(document).bind('ready.moonray_order_form_jb_788',function(){
        $("div.jb_788 form").moonrayOrderForm({
            timeZoneOffset:8,
    ...
    <div class="moonray_forms moonray_order_form jb_788 moon-ray-hide-quick-cost">
    <form action="https://forms.moon-ray.com/v2.4/form_processor.php?" method="post">
    <input type="hidden" name="hash" value="e369853df766fa44e1ed0ff613f563bd">
    <input type="hidden" name="uid" value="p2c12106f34">
    <input type="hidden" name="tags" value="">
    <input type="hidden" name="sequence" value="">
	
	<input type="hidden" name="contact_id" id="contact_id_jb_788" value="" />
	<input type="hidden" id="afft_jb_788" name="afft_" value="" />
	<input type="hidden" id="aff_jb_788" name="aff_" value="" />
	<input type="hidden" id="sess_jb_788" name="sess_" value="" />
	<input type="hidden" id="ref_jb_788" name="ref_" value="" />
	<input type="hidden" id="own_jb_788" name="own_" value="" />
	<input type="hidden" id="oprid_jb_788" name="oprid" value="" />
