...
tobcheckout-step2fix.phpmedia="screen" .form-control {
display: block;
width: 100% !important;;
height: 34px;
padding: 6px 12px;
...
.row {
 ...
 <style> fieldset.contactInfo:before {
...
<body>
<?php include_once("_includes/gatobcheckout2.php") ?>
...
$(function() { // Shorthand for $(document).ready(function() {	
 $("#comboform-adjust").hide();
 $("#soloform-adjust").hide();

});
$(window).resize(function() {
        var wi = $(window).width();
		if (wi <= 751) {
		  if ($("#add_subscription").attr("checked") == 'checked') {
		  $("#comboform-adjust").show();
		  $("#comboform").hide();
		  $("#soloform-adjust").hide();
		  $("#soloform").hide();
		  } else {
...
<div id="wrapper">
  ...
  <div style="width:auto; max-width:900px; background-color:#FFFFFF !important; margin: 0 auto; border:1px solid grey;">
    <div style="width:auto:; max-width:900px; width:auto; margin: 0 auto; background-color:#FFF;">
      <div id="toplogo"><img src="_img/tamehisheartlogo.png" style="width:100%; max-width:170px; float:left;" / ></div>
      ...
      <div>
        <div id="guaranteebarlg"><img src="_img/guaranteebar.png" style="width:100%; max width:900px;" /></div>
        <div id="guaranteebarsm"><img src="_img/guaranteebarsm.png" style="width:100%; max width:480x;" /></div>
      </div>
      <div class="widget-basic col-md-12" style="width:90%; max-width:800px; padding: 15px 15px 15px 15px; margin-top: 10px; margin-right:auto; margin-left:auto;">
        <div class="checkbox">
          <label>
    ...
    $(document).bind('ready.moonray_order_form_jb_679',function(){
        ...
        <![endif]-->
        <div class="container">
          <div class="row moonray_forms jb_679 moon-ray-hide-quick-cost" style="max-width:800px; padding: 1px 3px 1px 3px;margin:0 auto;">
            <div class="col-sm-7" style="padding-left:0px;">
              <div class="row">
                <form action="https://forms.moon-ray.com/v2.4/form_processor.php?" method="post" class="form-horizontal">
                  ...
                  <img src="_img/securelogos.jpg" style="max-width:300px; width:100%;"/>
            ...
            <div class="col-sm-5" > <br>
              <img src="_img/thhbookcd.png" style="max-width:80px; width:100%; float:left;" />
              <p style="margin-top:5px; margin-left:10px; font-weight:bold;">Tame His Heart Ebook</p>
              <div style="clear:both;"></div>
              <div style="width:100%;">
                <div style="font-size:12px; float:left; width:50%; font-size:16px; font-weight:bold; text-align:left;">Product Price</div>
                <div style="font-size:12px; float:right; width:50%; font-size:16px; font-weight:bold; text-align:right; text-decoration:line-through;">29.97</div>
                <div style="clear:both;"></div>
              </div>
              <div style="width:100%;"> <img src="_img/lightline.png" style="width:100%; max-width:260px;" /> </div>
              <img src="_img/thhcds.png" style="max-width:80px; width:100%; float:left;" />
              <p style="margin-top:0px; margin-left:10px; font-weight:bold;">Discussions With Dating Experts</p>
              <div style="clear:both;"></div>
              <div style="width:100%;">
                <div style="font-size:12px; float:left; width:50%; font-size:16px; font-weight:bold; text-align:left;">Product Price</div>
                <div style="font-size:12px; float:right; width:50%; font-size:16px; font-weight:bold;text-align:right; text-decoration:line-through;">19.97</div>
                <div style="clear:both;"></div>
              </div>
              <br />
              <div style="width:100%;"> <img src="_img/lightline.png" style="width:100%; max-width:260px;" /> </div>
              <div style="width:100%;">
                <div style="font-size:12px; float:left; width:50%; font-size:16px; font-weight:bold; text-align:left;">Tax</div>
                <div style="font-size:12px; float:right; width:50%; font-size:16px; font-weight:bold;text-align:right;">0.00</div>
                <div style="clear:both;"></div>
              </div>
              <div style="width:100%;">
                <div style="font-size:12px; float:left; width:50%; font-size:16px; font-weight:bold; text-align:left;">Total</div>
                <div style="font-size:12px; float:right; width:50%; font-size:16px; font-weight:bold;text-align:right;"><span style="color:#C00;">0.00</span></div>
                <div style="clear:both;"></div>
              </div>
            </div>
          </div>
    ...
    $(document).bind('ready.moonray_order_form_jb_679',function(){
        ...
        <div class="container">
          <div class="row moonray_forms jb_679 moon-ray-hide-quick-cost" style="max-width:800px; padding: 1px 3px 1px 3px;margin:0 auto;">
            <div class="col-sm-5" style="padding-left:0;"> <br>
              <img src="_img/thhbookcd.png" style="max-width:80px; width:100%; float:left;" />
              <p style="margin-top:5px; margin-left:10px; font-weight:bold;">Tame His Heart Ebook</p>
              <div style="clear:both;"></div>
              <div style="width:100%;">
    ...
    $(document).bind('ready.moonray_order_form_jb_856',function(){
        ...
        <![endif]-->
        <div class="container">
          <div class="row moonray_forms jb_856 moon-ray-hide-quick-cost" style="max-width:800px; padding: 1px 3px 1px 3px;margin:0 auto;">
            <div class="col-sm-7" style="padding-left:0px;">
              <div class="row">
                <form action="https://forms.moon-ray.com/v2.4/form_processor.php?" method="post" class="form-horizontal">
            ...
            <div class="col-sm-7" style="padding-left:0px;">
              <div class="row">
                <form action="https://forms.moon-ray.com/v2.4/form_processor.php?" method="post" class="form-horizontal">
                  ...
                  <h2 style="font-size:22px; margin:0px 0px 10px 0px;">&nbsp;</h2>
                  <h2 style="font-size:22px; margin:0px 0px 10px 0px;">Credit Card Details</h2>
                  <div class="form-group">
                    <div class="col-sm-9">
                      <input type="text" name="payment_number" value="" class="form-control" size="30" placeholder="Card Number*"/>
...
<div id="footer" style="margin: 0 auto;">
  <div class="container clearfix">
    ...
    <br/>
    <p>We take your privacy very seriously. Disclaimer: Results will vary, and you should not use this information as a substitute for help from a licensed professional. Good luck!</p>
    <p>OneTaste™ and other marks indicated on our site are registered trademarks of OneTaste™ in the United States and/or other countries. Other OneTaste™ marks, graphics, logos, page headers, button icons, scripts noted on the Site are OneTaste™’s service marks, trademarks and trade dress and are the sole and exclusive property of OneTaste™. OneTaste™'s service marks, trademarks and trade dress may not be used in any manner that is likely to cause confusion among customers, in any manner that disparages or discredits OneTaste™ and in connection with any service or product that is not sponsored, endorsed or produced by OneTaste™. All other trademarks not owned by OneTaste™ or its subsidiaries that appear on this site are the property of their respective owners, who may or may not be affiliated with, connected to, or sponsored by OneTaste™ or its subsidiaries.<br />
      <br />
      <br />
      OneTaste inc., 1072 Folsom Street, Suite 483, San Francisco, CA 94103</p>
  </div>
  <img class="bottom" src="_img/safepurchase.png" /> </div>
